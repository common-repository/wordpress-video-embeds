<?php
/*
Plugin Name: WordPress Video Embeds
Plugin URI: 
Description: A plugin to easily embed videos from many video sharing sites. Use the shortcode [website videoid] to embed the videos direcrly into the blog post, pages, comments and RSS Feed.
Version: 1.1
Author: Abhik
...
define("UOL_WIDTH", get_option('wpvideowidth'));
define("UOL_HEIGHT", get_option('wpvideoheight'));
define("UOL_REGEXP", "/\[uol ([[:print:]]+)\]/");
define("UOL_TARGET", "<object width=\"###WIDTH###\" height=\"###HEIGHT###\" id=\"player_###URL###\" classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" ><param value=\"true\" name=\"allowfullscreen\"/><param value=\"http://storage.mais.uol.com.br/embed.swf?mediaId=###URL###\" name=\"movie\"/><param value=\"always\" name=\"allowscriptaccess\"/><param value=\"window\" name=\"wmode\"/><embed id=\"player_###URL###\" width=\"###WIDTH###\" height=\"###HEIGHT###\" type=\"application/x-shockwave-flash\" allowscriptaccess=\"always\" allowfullscreen=\"true\" src=\"http://storage.mais.uol.com.br/embed.swf?mediaId=###URL###\" wmode=\"window\" /></embed></object>");

function uol_plugin_callback($match)
{
	...
	if (count($tag_parts) > 2) {
		if ($tag_parts[2] == 0) {
			$output = str_replace("###WIDTH###", UOL_WIDTH, $output);
		} else {
			$output = str_replace("###WIDTH###", $tag_parts[2], $output);
		}
		if ($tag_parts[3] == 0) {
			$output = str_replace("###HEIGHT###", UOL_HEIGHT, $output);
		} else {
...
function uol_plugin($content)
{
	return (preg_replace_callback(UOL_REGEXP, 'uol_plugin_callback', $content));
}

add_filter('the_content', 'uol_plugin',1);
add_filter('the_content_rss', 'uol_plugin');
add_filter('comment_text', 'uol_plugin');
add_filter('the_excerpt', 'uol_plugin');

// Globo.com

define("GLOBO_WIDTH", get_option('wpvideowidth'));
define("GLOBO_HEIGHT", get_option('wpvideoheight'));
define("GLOBO_REGEXP", "/\[globo ([[:print:]]+)\]/");
define("GLOBO_TARGET", "<object width=\"###WIDTH###\" height=\"###HEIGHT###\"><param value=\"http://video.globo.com/Portal/videos/cda/player/player.swf\" name=\"movie\" /><param value=\"high\" name=\"quality\" /><param value=\"midiaId=###URL###&autoStart=false&width=###WIDTH###&height=###HEIGHT###\" name=\"FlashVars\" /><embed width=\"###WIDTH###\" height=\"###HEIGHT###\" flashvars=\"midiaId=###URL###&autoStart=false&width=###WIDTH###&height=###HEIGHT###\" type=\"application/x-shockwave-flash\" quality=\"high\" src=\"http://video.globo.com/Portal/videos/cda/player/player.swf\"></embed></object>");

function globo_plugin_callback($match)
{
	$tag_parts = explode(" ", rtrim($match[0], "]"));
	$output = GLOBO_TARGET;
	$output = str_replace("###URL###", $tag_parts[1], $output);
	if (count($tag_parts) > 2) {
		if ($tag_parts[2] == 0) {
			$output = str_replace("###WIDTH###", GLOBO_WIDTH, $output);
		} else {
			$output = str_replace("###WIDTH###", $tag_parts[2], $output);
		}
		if ($tag_parts[3] == 0) {
			$output = str_replace("###HEIGHT###", GLOBO_HEIGHT, $output);
		} else {
			$output = str_replace("###HEIGHT###", $tag_parts[3], $output);
		}
	} else {
...
function globo_plugin($content)
{
	return (preg_replace_callback(GLOBO_REGEXP, 'globo_plugin_callback', $content));
}

add_filter('the_content', 'globo_plugin',1);
add_filter('the_content_rss', 'globo_plugin');
add_filter('comment_text', 'globo_plugin');
add_filter('the_excerpt', 'globo_plugin');

// Novamov Code

define("NOVAMOV_WIDTH", get_option('wpvideowidth'));
define("NOVAMOV_HEIGHT", get_option('wpvideoheight'));
...
define("KEWEGO_WIDTH", get_option('wpvideowidth'));
define("KEWEGO_HEIGHT", get_option('wpvideoheight'));
...
define("FLICKR_WIDTH", get_option('wpvideowidth'));
define("FLICKR_HEIGHT", get_option('wpvideoheight'));
...
define("FB_WIDTH", get_option('wpvideowidth'));
define("FB_HEIGHT", get_option('wpvideoheight'));
define("FB_REGEXP", "/\[facebook ([[:print:]]+)\]/");
...
define("CURRENT_WIDTH", get_option('wpvideowidth'));
define("CURRENT_HEIGHT", get_option('wpvideoheight'));
...
define("SCREENCAST_WIDTH", get_option('wpvideowidth'));
define("SCREENCAST_HEIGHT", get_option('wpvideoheight'));
...
define("DOTSUB_WIDTH", get_option('wpvideowidth'));
define("DOTSUB_HEIGHT", get_option('wpvideoheight'));
...
define("ONSMASH_WIDTH", get_option('wpvideowidth'));
define("ONSMASH_HEIGHT", get_option('wpvideoheight'));
...
define("SMOTRI_WIDTH", get_option('wpvideowidth'));
define("SMOTRI_HEIGHT", get_option('wpvideoheight'));
...
define("WAT_WIDTH", get_option('wpvideowidth'));
define("WAT_HEIGHT", get_option('wpvideoheight'));
...
define("GUBA_WIDTH", get_option('wpvideowidth'));
define("GUBA_HEIGHT", get_option('wpvideoheight'));
...
define("GOALVIDEOZ_WIDTH", get_option('wpvideowidth'));
define("GOALVIDEOZ_HEIGHT", get_option('wpvideoheight'));
...
define("MOJVIDEO_WIDTH", get_option('wpvideowidth'));
define("MOJVIDEO_HEIGHT", get_option('wpvideoheight'));
...
define("CLIPSYN_WIDTH", get_option('wpvideowidth'));
define("CLIPSYN_HEIGHT", get_option('wpvideoheight'));
...
define("YOUREPORTER_WIDTH", get_option('wpvideowidth'));
define("YOUREPORTER_HEIGHT", get_option('wpvideoheight'));
...
define("GENERIC_FLASH_WIDTH", get_option('wpvideowidth'));
define("GENERIC_FLASH_HEIGHT", get_option('wpvideoheight'));
...
define("FUNNYORDIE_WIDTH", get_option('wpvideowidth'));
define("FUNNYORDIE_HEIGHT", get_option('wpvideoheight'));
...
define("TRILULILU_WIDTH", get_option('wpvideowidth'));
define("TRILULILU_HEIGHT", get_option('wpvideoheight'));
...
define("D1G_WIDTH", get_option('wpvideowidth'));
define("D1G_HEIGHT", get_option('wpvideoheight'));
...
define("REELZCHANNEL_WIDTH", get_option('wpvideowidth'));
define("REELZCHANNEL_HEIGHT", get_option('wpvideoheight'));
...
define("MEGAVIDEO_WIDTH", get_option('wpvideowidth'));
define("MEGAVIDEO_HEIGHT", get_option('wpvideoheight'));
...
define("MSN_WIDTH", get_option('wpvideowidth'));
define("MSN_HEIGHT", get_option('wpvideoheight'));
...
define("YTPLAYLIST_WIDTH", get_option('wpvideowidth'));
define("YTPLAYLIST_HEIGHT", get_option('wpvideoheight'));
...
define("MNCAST_WIDTH", get_option('wpvideowidth'));
define("MNCAST_HEIGHT", get_option('wpvideoheight'));
...
define("HH_WIDTH", get_option('wpvideowidth'));
define("HH_HEIGHT", get_option('wpvideoheight'));
...
define("COLLEGEHUMOR_WIDTH", get_option('wpvideowidth'));
define("COLLEGEHUMOR_HEIGHT", get_option('wpvideoheight'));
...
define("JUMPCUT_WIDTH", get_option('wpvideowidth'));
define("JUMPCUT_HEIGHT", get_option('wpvideoheight'));
...
define("CC_WIDTH",  get_option('wpvideowidth'));
define("CC_HEIGHT", get_option('wpvideoheight'));
...
define("SS_WIDTH", get_option('wpvideowidth'));
define("SS_HEIGHT", get_option('wpvideoheight'));
...
define("TT_WIDTH", get_option('wpvideowidth'));
define("TT_HEIGHT", get_option('wpvideoheight'));
...
define("VSOCIAL_WIDTH", get_option('wpvideowidth'));
define("VSOCIAL_HEIGHT", get_option('wpvideoheight'));
...
define("LASTFM_WIDTH", get_option('wpvideowidth'));
define("LASTFM_HEIGHT", get_option('wpvideoheight'));
...
define("SUMOTV_WIDTH", get_option('wpvideowidth'));
define("SUMOTV_HEIGHT", get_option('wpvideoheight'));
...
define("VIDEONL_WIDTH", get_option('wpvideowidth'));
define("VIDEONL_HEIGHT", get_option('wpvideoheight'));
...
define("BRIGHTCOVE_WIDTH", get_option('wpvideowidth'));
define("BRIGHTCOVE_HEIGHT", get_option('wpvideoheight'));
...
define("ANIBOOM_WIDTH", get_option('wpvideowidth'));
define("ANIBOOM_HEIGHT", get_option('wpvideoheight'));
...
define("CELLFISH_WIDTH", get_option('wpvideowidth'));
define("CELLFISH_HEIGHT", get_option('wpvideoheight'));
...
define("TUTV_WIDTH", get_option('wpvideowidth'));
define("TUTV_HEIGHT", get_option('wpvideoheight'));
...
define("YAHOO_WIDTH", get_option('wpvideowidth'));
define("YAHOO_HEIGHT", get_option('wpvideoheight'));
...
define("YAHOO_TARGET", "<iframe frameborder=\"0\" width=\"###WIDTH###\" height=\"###HEIGHT###\" src=\"http://d.yimg.com/nl/omg/site/player.html#lang=en-IN&vid=###URL###\"></iframe>");
...
define("MYSPACETV_WIDTH", get_option('wpvideowidth'));
define("MYSPACETV_HEIGHT", get_option('wpvideoheight'));
...
define("VEOH_WIDTH", get_option('wpvideowidth'));
define("VEOH_HEIGHT", get_option('wpvideoheight'));
...
define("WANDEO_WIDTH", get_option('wpvideowidth'));
define("WANDEO_HEIGHT", get_option('wpvideoheight'));
...
define("GLUMBERT_WIDTH", get_option('wpvideowidth'));
define("GLUMBERT_HEIGHT", get_option('wpvideoheight'));
...
define("GameVideos_WIDTH", get_option('wpvideowidth'));
define("GameVideos_HEIGHT", get_option('wpvideoheight'));
...
define("GameTrailers_WIDTH", get_option('wpvideowidth'));
define("GameTrailers_HEIGHT", get_option('wpvideoheight'));
...
define("IFILM_WIDTH", get_option('wpvideowidth'));
define("IFILM_HEIGHT", get_option('wpvideoheight'));
...
define("LIVELEAK_WIDTH", get_option('wpvideowidth'));
define("LIVELEAK_HEIGHT", get_option('wpvideoheight'));
...
define("GROUPER_WIDTH", get_option('wpvideowidth'));
define("GROUPER_HEIGHT", get_option('wpvideoheight'));
...
define("UNCUT_WIDTH", get_option('wpvideowidth'));
define("UNCUT_HEIGHT", get_option('wpvideoheight'));
...
define("REVVER_WIDTH", get_option('wpvideowidth'));
define("REVVER_HEIGHT", get_option('wpvideoheight'));
...
define("BLIPTV_WIDTH", get_option('wpvideowidth'));
define("BLIPTV_HEIGHT", get_option('wpvideoheight'));
...
define("VIDEOTUBE_WIDTH", get_option('wpvideowidth'));
define("VIDEOTUBE_HEIGHT", get_option('wpvideoheight'));
...
define("VIMEO_WIDTH", get_option('wpvideowidth'));
define("VIMEO_HEIGHT", get_option('wpvideoheight'));
...
// Metacafe Code
define("METACAFE_WIDTH", get_option('wpvideowidth'));
define("METACAFE_HEIGHT", get_option('wpvideoheight'));
...
define("BREAK_WIDTH", get_option('wpvideowidth'));
define("BREAK_HEIGHT", get_option('wpvideoheight'));
...
define("MYVIDEO_WIDTH", get_option('wpvideowidth'));
define("MYVIDEO_HEIGHT", get_option('wpvideoheight'));
...
define("DAILYMOTION_WIDTH", get_option('wpvideowidth'));
define("DAILYMOTION_HEIGHT", get_option('wpvideoheight'));
...
define("SEVENLOAD_WIDTH", get_option('wpvideowidth'));
define("SEVENLOAD_HEIGHT", get_option('wpvideoheight'));
...
define("CLIPFISH_WIDTH", get_option('wpvideowidth'));
define("CLIPFISH_HEIGHT", get_option('wpvideoheight'));
...
define("GOOGLE_WIDTH", get_option('wpvideowidth'));
define("GOOGLE_HEIGHT", get_option('wpvideoheight'));
...
define("YOUTUBE_WIDTH", get_option('wpvideowidth'));
define("YOUTUBE_HEIGHT", get_option('wpvideoheight'));
...
/*
function wpvideoscopy(){
$creditbox = get_option('creditlink');
if ( $creditbox == "true" ) {
 echo '<p style="margin:auto;font-size:x-small;text-align:center;">Powered by <a href="http://www.itsabhik.com/">WP Video Embeds</a>.</p>';
}
add_action('wp_footer','wpvideoscopy');
} */
?>